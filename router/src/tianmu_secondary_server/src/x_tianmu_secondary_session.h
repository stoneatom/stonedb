...
#ifndef MYSQLD_TIANMU_SECONDARY_X_TIANMU_SESSION_INCLUDED
#define MYSQLD_TIANMU_SECONDARY_X_TIANMU_SESSION_INCLUDED
...
#include "router/src/tianmu_secondary_server/src/tianmu_secondary_session.h"
...
class MySQLServerTianmuSecondarySessionX : public MySQLServerTianmuSecondarySession {
 public:
  using clock_type = std::chrono::steady_clock;

  MySQLServerTianmuSecondarySessionX(
...
#endif  // MYSQLD_TIANMU_SECONDARY_X_TIANMU_SESSION_INCLUDED
