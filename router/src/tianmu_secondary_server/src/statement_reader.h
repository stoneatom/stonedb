...
#ifndef MYSQLD_TIANMU_SECONDARY_STATEMENT_READER_INCLUDED
#define MYSQLD_TIANMU_SECONDARY_STATEMENT_READER_INCLUDED
...
#endif  // MYSQLD_TIANMU_SECONDARY_STATEMENT_READER_INCLUDED
