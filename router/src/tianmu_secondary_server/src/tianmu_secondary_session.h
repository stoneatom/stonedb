...
#ifndef MYSQLD_TIANMU_SECONDARY_TIANMU_SESSION_INCLUDED
#define MYSQLD_TIANMU_SECONDARY_TIANMU_SESSION_INCLUDED
...
class MySQLServerTianmuSecondarySession {
 public:
  MySQLServerTianmuSecondarySession(
  ...
  virtual ~MySQLServerTianmuSecondarySession() = default;
...
#endif  // MYSQLD_TIANMU_SECONDARY_TIANMU_SESSION_INCLUDED
