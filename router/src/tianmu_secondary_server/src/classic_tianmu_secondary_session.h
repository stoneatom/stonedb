...
#ifndef MYSQLD_TIANMU_SECONDARY_CLASSIC_TIANMU_SESSION_INCLUDED
#define MYSQLD_TIANMU_SECONDARY_CLASSIC_TIANMU_SESSION_INCLUDED
...
class MySQLServerTianmuSecondarySessionClassic : public MySQLServerTianmuSecondarySession {
 public:
  MySQLServerTianmuSecondarySessionClassic(
...
#endif  // MYSQLD_TIANMU_SECONDARY_CLASSIC_TIANMU_SESSION_INCLUDED
