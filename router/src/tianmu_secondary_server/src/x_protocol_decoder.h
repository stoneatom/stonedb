...
#ifndef MYSQLD_TIANMU_SECONDARY_X_PROTOCOL_DECODER_INCLUDED
#define MYSQLD_TIANMU_SECONDARY_X_PROTOCOL_DECODER_INCLUDED
...
#endif  // MYSQLD_TIANMU_SECONDARY_X_PROTOCOL_DECODER_INCLUDED
