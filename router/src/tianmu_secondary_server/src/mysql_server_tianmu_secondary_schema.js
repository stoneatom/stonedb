...
{
  "title": "MySQL Server Tianmu Secondary Data",
      "description": "JSON Schema of the input files of the mysql-server-tianmu-secondary",
      ...
      "definitions": {
        ...
        "ResultsetColumn": {
          ...
          "properties": {
            ...
            "comment": {
              "description":
                  "additional information/comment about the column; ignored by the server tianmu secondary, for self-documenting only",
              "type": "string"
            },
            "repeat": {
              "description":
      ...
      "properties": {
        ...
        "stmts": {
          "description":
              "RPCs that the tianmu secondary will expect and process one after the other",
          "type": "array",
