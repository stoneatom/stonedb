...
#ifndef MYSQLD_MYSQL_SERVER_TIANMU_SECONDARY_INCLUDED
#define MYSQLD_MYSQL_SERVER_TIANMU_SECONDARY_INCLUDED
...
class MySQLServerTianmuSecondary {
 public:
   ...
   *                        connections
   * @param protocol the protocol this tianmu secondary instance speaks: "x" or "classic"
   ...
   */
  MySQLServerTianmuSecondary(net::io_context &io_ctx, std::string expected_queries_file,
...
#endif  // MYSQLD_MYSQL_SERVER_TIANMU_SECONDARY_INCLUDED
