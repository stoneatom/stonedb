...
namespace core {
CQTerm::CQTerm()
    : type(common::CT::UNK), vc(nullptr), vc_id(common::NULL_VALUE_32), is_vc_owner(false), item(nullptr) {}

CQTerm::CQTerm(int v, Item *item_arg)
    : type(common::CT::UNK), vc(nullptr), vc_id(v), is_vc_owner(false), item(item_arg) {}
