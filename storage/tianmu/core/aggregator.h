...
*/
#ifndef TIANMU_CORE_AGGREGATOR_H_
#define TIANMU_CORE_AGGREGATOR_H_
#pragma once
 ...
 */
class TIANMUAggregator {
 public:
  TIANMUAggregator() = default;
  TIANMUAggregator(const TIANMUAggregator &sec) = default;
  virtual ~TIANMUAggregator() = default;
  // Obligatory part
   ...
   */
  virtual TIANMUAggregator *Copy() = 0;
   ...
   * functions. \pre TIANMUAggregator statistics should be updated.
   */
 ...
 * Start value: 0.
 */
class AggregatorCount64 : public TIANMUAggregator {
 public:
  ...
  TIANMUAggregator *Copy() override { return new AggregatorCount64(*this); }
 ...
 * Start value: 0.
 */
class AggregatorCount32 : public TIANMUAggregator {
 public:
  ...
  AggregatorCount32(const AggregatorCount32 &sec)
      : TIANMUAggregator(sec),
        ...
        cur_min_counter(sec.cur_min_counter),
        pack_count(sec.pack_count) {}
  TIANMUAggregator *Copy() override { return new AggregatorCount32(*this); }
...
#endif  // TIANMU_CORE_AGGREGATOR_H_
