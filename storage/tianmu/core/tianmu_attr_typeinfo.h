...
class AttributeTypeInfo {
 public:
  ...
  AttributeTypeInfo(common::ColumnType attrt, bool not_null, uint precision = 0, ushort scale = 0, bool auto_inc = false,
    ...
    flag_[static_cast<int>(enumATI::kAutoInc)] = auto_inc;
  ...
  bool NotNull() const { return flag_[static_cast<int>(enumATI::kNotNull)]; }
  bool AutoInc() const { return flag_[static_cast<int>(enumATI::kAutoInc)]; }
  ...
  bool IsLookup() const { return fmt_ == common::PackFmt::LOOKUP; }
