 ...
 public:
  ...
  class CQStep {
   public:
    ...
    TableID t1;  // the table id involved in this steps.
    TableID t2;  //
    TableID t3;  //

    AttrID a1, a2;      // attrs involved in this steps.
    CondID c1, c2, c3;  /// condtions in this steps.
    CQTerm e1, e2, e3;
  ...
  void TableAlias(TableID &t_out, const TableID &n, const char *tab_name = NULL, int cf_id = -1);
