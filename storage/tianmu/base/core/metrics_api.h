 ...
 */
#ifndef TIANMU_BASE_METRICS_API_H_
#define TIANMU_BASE_METRICS_API_H_
#pragma once
...
namespace std {
template <>
struct hash<Tianmu::base::metrics::impl::labels_type> {
  using argument_type = Tianmu::base::metrics::impl::labels_type;
  using result_type = ::std::size_t;
  result_type operator()(argument_type const &s) const {
    result_type h = 0;
    for (auto &&i : s) {
      boost::hash_combine(h, std::hash<Tianmu::base::sstring>{}(i.second));
    }
    return h;
  }
};
...
namespace std {
template <>
struct hash<Tianmu::base::metrics::impl::metric_id> {
  using argument_type = Tianmu::base::metrics::impl::metric_id;
  using result_type = ::std::size_t;
  result_type operator()(argument_type const &s) const {
    result_type const h1(std::hash<Tianmu::base::sstring>{}(s.group_name()));
    result_type const h2(std::hash<Tianmu::base::sstring>{}(s.instance_id()));
...
#endif  // TIANMU_BASE_METRICS_API_H_
