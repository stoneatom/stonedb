 ...
 */
#ifndef TIANMU_BASE_METRICS_REGISTRATION_H_
#define TIANMU_BASE_METRICS_REGISTRATION_H_
#pragma once
 ...
 * \brief holds the metric_groups definition needed by class that reports
 * metrics
 *
...
class metric_groups {
 ...
 public:
   ...
   *      make_counter("my_counter_name1", counter, description("my counter
   * description")), make_counter("my_counter_name2", counter, description("my
   * second counter description")), make_gauge("my_gauge_name1", gauge,
...
#endif  // TIANMU_BASE_METRICS_REGISTRATION_H_
