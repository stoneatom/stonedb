 ...
 */
#ifndef TIANMU_BASE_FSTREAM_H_
#define TIANMU_BASE_FSTREAM_H_
#pragma once
...
struct file_input_stream_options {
  ...
  Tianmu::base::io_priority_class io_priority_class = default_priority_class();
