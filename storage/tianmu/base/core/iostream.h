...
#ifndef TIANMU_BASE_IOSTREAM_H_
#define TIANMU_BASE_IOSTREAM_H_
#pragma once
...
namespace net {  // internal namespace
class packet;
}
...
class data_sink_impl {
 public:
  ...
  virtual temporary_buffer<char> allocate_buffer(size_t size) { return temporary_buffer<char>(size); }
  ...
  virtual future<> flush() { return make_ready_future<>(); }
...
class data_sink {
 ...
 public:
  ...
  temporary_buffer<char> allocate_buffer(size_t size) { return _dsi->allocate_buffer(size); }
  future<> put(std::vector<temporary_buffer<char>> data) { return _dsi->put(std::move(data)); }
  future<> put(temporary_buffer<char> data) { return _dsi->put(std::move(data)); }
  future<> put(net::packet p) { return _dsi->put(std::move(p)); }
  future<> flush() { return _dsi->flush(); }
  future<> close() { return _dsi->close(); }
};
