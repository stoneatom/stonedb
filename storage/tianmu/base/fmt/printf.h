 ...
 */
#ifndef TIANMU_BASE_PRINTF_H_
#define TIANMU_BASE_PRINTF_H_
#pragma once
...
class ArgConverter : public ArgVisitor<ArgConverter<T>, void> {
 ...
 public:
  ...
  void visit_any_int(U value) {
    ...
    using internal::Arg;
    using TargetType = typename internal::Conditional<is_same<T, void>::value, U, T>::type;
...
class BasicPrintfArgFormatter : public internal::ArgFormatterBase<Impl, Char, Spec> {
 private:
  ...
  using Base = internal::ArgFormatterBase<Impl, Char, Spec>;
