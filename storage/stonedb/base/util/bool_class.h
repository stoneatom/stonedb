 ...
 */
#ifndef STONEDB_BASE_BOOL_CLASS_H_
#define STONEDB_BASE_BOOL_CLASS_H_
#pragma once
...
class bool_class {
 ...
 public:
  ...
  /// Logical OR.
  friend bool_class operator||(bool_class x, bool_class y) noexcept { return bool_class(x._value || y._value); }

  /// Logical AND.
  friend bool_class operator&&(bool_class x, bool_class y) noexcept { return bool_class(x._value && y._value); }

  /// Logical NOT.
  friend bool_class operator!(bool_class x) noexcept { return bool_class(!x._value); }

  /// Equal-to operator.
  friend bool operator==(bool_class x, bool_class y) noexcept { return x._value == y._value; }

  /// Not-equal-to operator.
  friend bool operator!=(bool_class x, bool_class y) noexcept { return x._value != y._value; }

  /// Prints bool_class value to an output stream.
  friend std::ostream &operator<<(std::ostream &os, bool_class v) { return os << (v._value ? "true" : "false"); }
};
...
#endif  // STONEDB_BASE_BOOL_CLASS_H_
