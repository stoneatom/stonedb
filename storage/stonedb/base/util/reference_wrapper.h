 ...
 */
#ifndef STONEDB_BASE_REFERENCE_WRAPPER_H_
#define STONEDB_BASE_REFERENCE_WRAPPER_H_
#pragma once
...
/// also the reason why base::reference_wrapper was introduced) is that it
...
/// base::reference_wrapper is used mainly to force user to explicitly
...
#endif  // STONEDB_BASE_REFERENCE_WRAPPER_H_
