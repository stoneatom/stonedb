 ...
 */
#ifndef STONEDB_BASE_PRINT_SAFE_H_
#define STONEDB_BASE_PRINT_SAFE_H_
#pragma once
...
// Outputs string to stderr.
// Async-signal safe.
inline void print_safe(const char *str) noexcept { print_safe(str, strlen(str)); }
...
#endif  // STONEDB_BASE_PRINT_SAFE_H_
