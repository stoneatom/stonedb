 ...
 */
#ifndef STONEDB_BASE_INDIRECT_H_
#define STONEDB_BASE_INDIRECT_H_
#pragma once
...
// This header defines functors for comparing and hashing pointers by pointed-to
// values instead of pointer addresses.
//
// Examples:
//
//  std::multiset<shared_ptr<sstring>, indirect_less<shared_ptr<sstring>>>
//  _multiset;
//
//  std::unordered_map<shared_ptr<sstring>, bool,
//      indirect_hash<shared_ptr<sstring>>,
//      indirect_equal_to<shared_ptr<sstring>>> _unordered_map;
//
...
#endif  // STONEDB_BASE_INDIRECT_H_
