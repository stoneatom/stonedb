 ...
 */
#ifndef STONEDB_BASE_FSTREAM_H_
#define STONEDB_BASE_FSTREAM_H_
#pragma once
...
struct file_input_stream_options {
  ...
  stonedb::base::io_priority_class io_priority_class = default_priority_class();
...
/// \param len Maximum number of bytes to read; the stream will stop at
/// end-of-file
