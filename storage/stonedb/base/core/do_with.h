 ...
 */
#ifndef STONEDB_BASE_DO_WITH_H_
#define STONEDB_BASE_DO_WITH_H_
#pragma once
...
inline auto do_with(T &&rvalue, F &&f) {
...
///
/// \param lock the lock, which is any object having providing a lock() /
/// unlock() semantics.
