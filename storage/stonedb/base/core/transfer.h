...
#ifndef STONEDB_BASE_TRANSFER_H_
#define STONEDB_BASE_TRANSFER_H_
#pragma once
...
// (this copies the object from @from to @to).  If no exceptions are
// encountered, call transfer_pass2(allocator, &from, &to).  This destroys the
// object at the origin.  If exceptions were encountered, simply destroy all
// copied objects.
//
...
template <typename T, typename Alloc>
inline void transfer_pass2([[maybe_unused]] Alloc &a, [[maybe_unused]] T *from, [[maybe_unused]] T *to,
                           typename std::enable_if<std::is_nothrow_move_constructible<T>::value>::type * = nullptr) {}
...
#endif  // STONEDB_BASE_TRANSFER_H_
