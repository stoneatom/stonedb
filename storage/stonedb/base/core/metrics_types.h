 ...
 */
#ifndef STONEDB_BASE_METRICS_TYPES_H_
#define STONEDB_BASE_METRICS_TYPES_H_
#pragma once
#include <vector>
...
struct histogram {
  ...
  double sample_sum = 0;
  std::vector<histogram_bucket> buckets;  // Ordered in increasing order of upper_bound, +Inf bucket is
                                          // optional.
...
#endif  // STONEDB_BASE_METRICS_TYPES_H_
