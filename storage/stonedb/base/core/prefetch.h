 ...
 */
#ifndef STONEDB_BASE_PREFETCH_H_
#define STONEDB_BASE_PREFETCH_H_
#pragma once
...
// "The value locality must be a compile-time constant integer between zero and
// three. A value of
//  zero means that the data has no temporal locality, so it need not be left in
//  the cache after the access. A value of three means that the data has a high
//  degree of temporal locality and should be left in all levels of cache
//  possible. Values of one and two mean, respectively, a low or moderate degree
...
#endif  // STONEDB_BASE_PREFETCH_H_
