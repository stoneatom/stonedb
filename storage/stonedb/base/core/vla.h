...
#ifndef STONEDB_BASE_VLA_H_
#define STONEDB_BASE_VLA_H_
#pragma once
...
inline std::unique_ptr<S, free_deleter> make_struct_with_vla(E S::*last, size_t nr) {
  ...
  auto p = std::unique_ptr<char, free_deleter>(reinterpret_cast<char *>(::malloc(offset + element_size * nr)));
