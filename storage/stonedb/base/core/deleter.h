 ...
 */
#ifndef STONEDB_BASE_DELETER_H_
#define STONEDB_BASE_DELETER_H_
#pragma once
...
class deleter final {
 ...
 public:
  ...
  deleter(raw_object_tag, void *object) : _impl(from_raw_object(object)) {}
  /// \endcond
...
///
/// \param d deleter that will become part of the new deleter's encapsulated
/// action \param o object whose destructor becomes part of the new deleter's
/// encapsulated action \related deleter
template <typename Object>
deleter make_deleter(deleter next, Object o) {
  return deleter(new lambda_deleter_impl<Object>(std::move(next), std::move(o)));
}

/// Makes a \ref deleter that encapsulates the action of destroying an object.
/// The input object is moved to the deleter, and destroyed when the deleter is
/// destroyed.
///
/// \param o object whose destructor becomes the new deleter's encapsulated
/// action \related deleter
template <typename Object>
