...
#ifndef STONEDB_BASE_WEAK_PTR_H_
#define STONEDB_BASE_WEAK_PTR_H_
#pragma once
...
/// A live weak_ptr<> object doesn't prevent the referenced object form being
/// destroyed.
///
/// The underlying pointer held by weak_ptr<> is valid as long as the referenced
/// object is alive. When the object dies, all weak_ptr objects associated with
/// it are emptied.
///
...
class weakly_referencable {
  boost::intrusive::list<
      weak_ptr<T>, boost::intrusive::member_hook<weak_ptr<T>, typename weak_ptr<T>::hook_type, &weak_ptr<T>::_hook>,
...
#endif  // STONEDB_BASE_WEAK_PTR_H_
