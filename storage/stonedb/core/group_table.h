...
*/
#ifndef STONEDB_CORE_GROUP_TABLE_H_
...
class GroupTable : public mm::TraceableObject {
 public:
  ...
  STONEDBAggregator *AttrAggregator(int col) { return aggregator[col]; }
 ...
 private:
  ...
  std::vector<STONEDBAggregator *> aggregator;  // a table of actual aggregators
...
#endif  // STONEDB_CORE_GROUP_TABLE_H_
