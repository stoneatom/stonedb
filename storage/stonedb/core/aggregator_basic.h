...
*/
#ifndef STONEDB_CORE_AGGREGATOR_BASIC_H_
 ...
 */
class AggregatorSum64 : public STONEDBAggregator {
  using STONEDBAggregator::PutAggregatedValue;

 public:
  AggregatorSum64() : STONEDBAggregator() {
    pack_sum = 0;
    pack_min = 0;
    pack_max = 0;
  ...
  STONEDBAggregator *Copy() override { return new AggregatorSum64(*this); }
 ...
 */
class AggregatorSumD : public STONEDBAggregator {
  using STONEDBAggregator::PutAggregatedValue;

 public:
  AggregatorSumD() : STONEDBAggregator() { pack_sum = 0; }
  AggregatorSumD(AggregatorSumD &sec) : STONEDBAggregator(sec), pack_sum(sec.pack_sum) {}
  STONEDBAggregator *Copy() override { return new AggregatorSumD(*this); }
  int BufferByteSize() override { return 8; }
  void PutAggregatedValue(unsigned char *buf, int64_t v, int64_t factor) override;
 ...
 */
class AggregatorAvg64 : public STONEDBAggregator {
  using STONEDBAggregator::PutAggregatedValue;
 ...
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorAvg64(*this); }
 ...
 * Start value: 0, but GetValueD will return NULL_VALUE_D.
 */
class AggregatorAvgD : public STONEDBAggregator {
 public:
  using STONEDBAggregator::PutAggregatedValue;

  AggregatorAvgD() : STONEDBAggregator() {
    pack_not_nulls = 0;
    pack_sum = 0;
  }
  AggregatorAvgD(AggregatorAvgD &sec)
      : STONEDBAggregator(sec), pack_sum(sec.pack_sum), pack_not_nulls(sec.pack_not_nulls) {}
  STONEDBAggregator *Copy() override { return new AggregatorAvgD(*this); }
  int BufferByteSize() override { return 16; }
  void PutAggregatedValue(unsigned char *buf, int64_t v, int64_t factor) override;
  void PutAggregatedValue(unsigned char *buf, const types::BString &v, int64_t factor) override;
  void Merge(unsigned char *buf, unsigned char *src_buf) override;
...
class AggregatorAvgYear : public AggregatorAvgD {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorAvgYear(*this); }
  void PutAggregatedValue(unsigned char *buf, int64_t v, int64_t factor) override;
  void PutAggregatedValue(unsigned char *buf, const types::BString &v, int64_t factor) override;
  void Merge(unsigned char *buf, unsigned char *src_buf) override;
...
class AggregatorMin : public STONEDBAggregator {
 public:
  using STONEDBAggregator::PutAggregatedValue;
  AggregatorMin() : STONEDBAggregator() {}
  AggregatorMin(AggregatorMin &sec) : STONEDBAggregator(sec) {}
  // Optimization part
...
class AggregatorMin32 : public AggregatorMin {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorMin32(*this); }
...
class AggregatorMin64 : public AggregatorMin {
 public:
  ...
  AggregatorMin64(AggregatorMin64 &sec)
      : AggregatorMin(sec), stat_max(sec.stat_max), pack_min(sec.pack_min), null_group_found(sec.null_group_found) {}
  STONEDBAggregator *Copy() override { return new AggregatorMin64(*this); }
  int BufferByteSize() override { return 8; }
  void PutAggregatedValue(unsigned char *buf, int64_t factor) override {
    stats_updated = false;
...
class AggregatorMinD : public AggregatorMin {
 public:
  ...
  AggregatorMinD(AggregatorMinD &sec)
      : AggregatorMin(sec), stat_max(sec.stat_max), pack_min(sec.pack_min), null_group_found(sec.null_group_found) {}
  STONEDBAggregator *Copy() override { return new AggregatorMinD(*this); }
  int BufferByteSize() override { return 8; }
  void PutAggregatedValue(unsigned char *buf, int64_t v, int64_t factor) override;
  void Merge(unsigned char *buf, unsigned char *src_buf) override;
  double GetValueD(unsigned char *buf) override { return *((double *)buf); }
...
class AggregatorMinT : public AggregatorMin {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorMinT(*this); }
...
class AggregatorMinT_UTF : public AggregatorMinT {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorMinT_UTF(*this); }
  void PutAggregatedValue(unsigned char *buf, const types::BString &v, int64_t factor) override;
  void Merge(unsigned char *buf, unsigned char *src_buf) override;
...
class AggregatorMax : public STONEDBAggregator {
 public:
  AggregatorMax() : STONEDBAggregator() {}
  AggregatorMax(AggregatorMax &sec) : STONEDBAggregator(sec) {}
  // Optimization part
  bool PackAggregationDistinctIrrelevant() override { return true; }
  bool FactorNeeded() override { return false; }
  bool IgnoreDistinct() override { return true; }
...
class AggregatorMax32 : public AggregatorMax {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorMax32(*this); }
  int BufferByteSize() override { return 4; }
  void PutAggregatedValue(unsigned char *buf, int64_t factor) override {
    stats_updated = false;
    if (*((int *)buf) == common::NULL_VALUE_32 || *((int *)buf) < (int)factor) *((int *)buf) = (int)factor;
...
class AggregatorMax64 : public AggregatorMax {
 public:
  ...
  AggregatorMax64(AggregatorMax64 &sec)
      : AggregatorMax(sec), stat_min(sec.stat_min), pack_max(sec.pack_max), null_group_found(sec.null_group_found) {}
  STONEDBAggregator *Copy() override { return new AggregatorMax64(*this); }
  int BufferByteSize() override { return 8; }
  void PutAggregatedValue(unsigned char *buf, int64_t factor) override {
    stats_updated = false;
    if (*((int64_t *)buf) == common::NULL_VALUE_64 || *((int64_t *)buf) < (int64_t)factor)
...
class AggregatorMaxD : public AggregatorMax {
 public:
  ...
  AggregatorMaxD(AggregatorMaxD &sec)
      : AggregatorMax(sec), stat_min(sec.stat_min), pack_max(sec.pack_max), null_group_found(sec.null_group_found) {}
  STONEDBAggregator *Copy() override { return new AggregatorMaxD(*this); }
  int BufferByteSize() override { return 8; }
  void PutAggregatedValue(unsigned char *buf, int64_t v, int64_t factor) override;
  void Merge(unsigned char *buf, unsigned char *src_buf) override;
  double GetValueD(unsigned char *buf) override { return *((double *)buf); }
...
class AggregatorMaxT : public AggregatorMax {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorMaxT(*this); }
  int BufferByteSize() override { return val_len + 2; }
  void PutAggregatedValue(unsigned char *buf, const types::BString &v, int64_t factor) override;
  void Merge(unsigned char *buf, unsigned char *src_buf) override;
  types::BString GetValueT(unsigned char *buf) override;
...
class AggregatorMaxT_UTF : public AggregatorMaxT {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorMaxT_UTF(*this); }
  void PutAggregatedValue(unsigned char *buf, const types::BString &v, int64_t factor) override;
  void Merge(unsigned char *buf, unsigned char *src_buf) override;
 ...
 * Start value: NULL_VALUE (32 bit), will return common::NULL_VALUE_64.
 */
class AggregatorList32 : public STONEDBAggregator {
 public:
  using STONEDBAggregator::PutAggregatedValue;
  AggregatorList32() : STONEDBAggregator() { value_set = false; }
  AggregatorList32(AggregatorList32 &sec) : STONEDBAggregator(sec), value_set(sec.value_set) {}
  STONEDBAggregator *Copy() override { return new AggregatorList32(*this); }
  int BufferByteSize() override { return 4; }
 ...
 * Start value: common::NULL_VALUE_64.
 */
class AggregatorList64 : public STONEDBAggregator {
 public:
  using STONEDBAggregator::PutAggregatedValue;
  AggregatorList64() : STONEDBAggregator() { value_set = false; }
  AggregatorList64(AggregatorList64 &sec) : STONEDBAggregator(sec), value_set(sec.value_set) {}
  STONEDBAggregator *Copy() override { return new AggregatorList64(*this); }
  int BufferByteSize() override { return 8; }
  void PutAggregatedValue(unsigned char *buf, int64_t v, [[maybe_unused]] int64_t factor) override {
    if (*((int64_t *)buf) == common::NULL_VALUE_64) {
      stats_updated = false;
 ...
 * \0,\0,\1.
 */
class AggregatorListT : public STONEDBAggregator {
 public:
  using STONEDBAggregator::PutAggregatedValue;
  AggregatorListT(int max_len) : val_len(max_len) { value_set = false; }
  AggregatorListT(AggregatorListT &sec) : STONEDBAggregator(sec), value_set(sec.value_set), val_len(sec.val_len) {}
  STONEDBAggregator *Copy() override { return new AggregatorListT(*this); }
  int BufferByteSize() override { return val_len + 2; }
  void PutAggregatedValue(unsigned char *buf, const types::BString &v, int64_t factor) override;
  void Merge(unsigned char *buf, unsigned char *src_buf) override;
  types::BString GetValueT(unsigned char *buf) override;
...
#endif  // STONEDB_CORE_AGGREGATOR_BASIC_H_
