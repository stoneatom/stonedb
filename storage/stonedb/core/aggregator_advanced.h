...
*/
#ifndef STONEDB_CORE_AGGREGATOR_ADVANCED_H_
#define STONEDB_CORE_AGGREGATOR_ADVANCED_H_
#pragma once
...
class AggregatorStat : public STONEDBAggregator {
 public:
  // Buffer contents for all functions, 8+8+8 bytes:
  //	<no_obj> <A> <Q>  - int64_t, double, double
  AggregatorStat() = default;
  AggregatorStat(const AggregatorStat &sec) : STONEDBAggregator(sec) {}
...
class AggregatorVarPop64 : public AggregatorStat64 {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorVarPop64(*this); }
...
class AggregatorVarSamp64 : public AggregatorStat64 {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorVarSamp64(*this); }
  int64_t GetValue64(unsigned char *buf) override;
};
...
class AggregatorStdPop64 : public AggregatorStat64 {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorStdPop64(*this); }
  int64_t GetValue64(unsigned char *buf) override;
};
...
class AggregatorStdSamp64 : public AggregatorStat64 {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorStdSamp64(*this); }
  int64_t GetValue64(unsigned char *buf) override;
};
...
class AggregatorVarPopD : public AggregatorStatD {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorVarPopD(*this); }
  int64_t GetValue64(unsigned char *buf) override;
};
...
class AggregatorVarSampD : public AggregatorStatD {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorVarSampD(*this); }
  int64_t GetValue64(unsigned char *buf) override;
};
...
class AggregatorStdPopD : public AggregatorStatD {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorStdPopD(*this); }
  int64_t GetValue64(unsigned char *buf) override;
};
...
class AggregatorStdSampD : public AggregatorStatD {
 public:
  ...
  STONEDBAggregator *Copy() override { return new AggregatorStdSampD(*this); }
  int64_t GetValue64(unsigned char *buf) override;
};

class AggregatorBitAnd : public STONEDBAggregator {
 public:
  using STONEDBAggregator::PutAggregatedValue;
  AggregatorBitAnd() = default;
  AggregatorBitAnd(const AggregatorBitAnd &sec) : STONEDBAggregator(sec) {}
  STONEDBAggregator *Copy() override { return new AggregatorBitAnd(*this); }
...
class AggregatorBitOr : public STONEDBAggregator {
 public:
  using STONEDBAggregator::PutAggregatedValue;
  AggregatorBitOr() = default;
  AggregatorBitOr(const AggregatorBitOr &sec) : STONEDBAggregator(sec) {}
  STONEDBAggregator *Copy() override { return new AggregatorBitOr(*this); }
  int BufferByteSize() override { return 8; }
...
class AggregatorBitXor : public STONEDBAggregator {
 public:
  using STONEDBAggregator::PutAggregatedValue;
  AggregatorBitXor() : STONEDBAggregator() {}
  AggregatorBitXor(const AggregatorBitXor &sec) : STONEDBAggregator(sec) {}
  STONEDBAggregator *Copy() override { return new AggregatorBitXor(*this); }
  int BufferByteSize() override { return 8; }
  void Reset(unsigned char *buf) override { *((int64_t *)buf) = 0; }
  void PutAggregatedValue(unsigned char *buf, int64_t v, int64_t factor) override {
...
class AggregatorGroupConcat : public STONEDBAggregator {
 public:
  using STONEDBAggregator::PutAggregatedValue;
  ...
  AggregatorGroupConcat(const AggregatorGroupConcat &sec)
      : STONEDBAggregator(sec), si(sec.si), gconcat_maxlen(sec.gconcat_maxlen), attrtype(sec.attrtype) {}

  STONEDBAggregator *Copy() override { return new AggregatorGroupConcat(*this); }
  ...
  void PutAggregatedValue([[maybe_unused]] unsigned char *buf, [[maybe_unused]] int64_t v,
    ...
    STONEDB_ERROR("Internal error: invalid call for AggregatorGroupConcat");
    return;
  }
 ...
 private:
  ...
  const uint gconcat_maxlen = stonedb_group_concat_max_len;
...
#endif  // STONEDB_CORE_AGGREGATOR_ADVANCED_H_
