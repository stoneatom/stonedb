...
/******* Join optimization state members end *******/
  ...
  */
  ...
  int optimize(unsigned char part = 0); // part: for stonedb
  void reset();
  void exec();
...
Item *remove_eq_conds(THD *thd, Item *cond, Item::cond_result *cond_value, unsigned char part = 0);
Item *optimize_cond(THD *thd, Item *conds, COND_EQUAL **cond_equal,
                    List<TABLE_LIST> *join_list,
                    bool build_equalities, Item::cond_result *cond_value, unsigned char part = 0);
