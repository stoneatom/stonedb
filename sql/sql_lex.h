...
enum enum_filetype { FILETYPE_CSV, FILETYPE_XML,FILETYPE_MEM };//STONEDB UPGRADE
...
class st_select_lex_unit: public Sql_alloc
{
  ...
  */
  ...
  SELECT_LEX *slave;
  ulonglong found_rows_for_union;//STONEDB UPGRADE
  bool saved_error;  //STONEDB UPGRADE
private:
  /**
