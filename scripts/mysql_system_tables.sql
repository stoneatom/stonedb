...
--
-- ADD SYS_STONEDB DATABASE
-- STONEDB UPGRADE
--
SET @cmd= "DROP DATABASE IF EXISTS sys_stonedb";
...
SET @cmd= "CREATE DATABASE sys_stonedb character set utf8";
