...
#
#my $DEFAULT_SUITES= "stonedb,main,sys_vars,binlog,federated,rpl,innodb,innodb_fts,innodb_zip,perfschema,funcs_1,opt_trace,parts,auth_sec";
my $DEFAULT_SUITES= "stonedb,main,sys_vars,binlog,federated,rpl,perfschema,funcs_1,opt_trace,parts,auth_sec";
my $opt_suites;
...
sub mysql_install_db {
  ...
  # Create StoneDB specific directories
  mkpath("$install_datadir/sys_stonedb");
  mkpath("$install_datadir/stonedb_data");
